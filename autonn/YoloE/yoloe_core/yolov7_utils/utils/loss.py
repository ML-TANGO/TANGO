...
from general import bbox_iou, bbox_iou_v9, bbox_alpha_iou, box_iou, box_giou, box_diou, box_ciou, xywh2xyxy
from v9_utils import TaskAlignedAssigner, dist2bbox, make_anchors, bbox2dist
from torch_utils import is_parallel, de_parallel
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_iou_v9(pred_bboxes_pos, target_bboxes_pos, xywh=False, CIoU=True)
        loss_iou = 1.0 - iou
