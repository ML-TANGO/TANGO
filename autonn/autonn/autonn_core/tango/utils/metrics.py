...
def ap_per_class_v9(tp, conf, pred_cls, target_cls, plot=False, save_dir='.', names=(), eps=1e-16, prefix=""):
...
def compute_ap(recall, precision, metric='v5'):
    ...
    if metric in ('v5', 'v9'):  # New YOLOv5 metric, same as MMDetection and Detectron2 repositories
...
class ConfusionMatrix_v9:
    ...
    def process_batch(self, detections, labels):
        ...
        from . import general
        iou = general.box_iou_v9(labels[:, 1:], detections[:, :4])
