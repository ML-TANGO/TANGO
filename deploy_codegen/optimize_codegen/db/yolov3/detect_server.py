...
def detect(
    ...
    source, nosave, project, exist_ok, update = (
        str(config["source"]),
        config["nosave"],
        config["project"],
        config["exist_ok"],
    ...
    device, weights, dnn, half = (
        config["device"],
        config["weights"],
        config["dnn"],
        config["half"],
    )
    imgsz, visualize, augment, conf_thres = (
        config["imgsz"],
        config["visualize"],
        config["augment"],
        config["conf_thres"],
    )
    iou_thres, conf_thres, classes, agnostic_nms = (
        config["iou_thres"],
        config["conf_thres"],
        config["classes"],
        config["agnostic_nms"],
    )
    max_det, save_crop, line_thickness, save_txt = (
        config["max_det"],
        config["save_crop"],
        config["line_thickness"],
        config["save_txt"],
    )
    save_conf, view_img, hide_labels, hide_conf = (
        config["save_conf"],
        config["view_img"],
        config["hide_labels"],
        config["hide_conf"],
