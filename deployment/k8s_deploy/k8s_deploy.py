...
class K8SDeploy:
    ...
    def run(self):
        ...
        if ret == 0:
            ...
            run_kubernetes=deployment.KubeJob(job_name=self.m_current_projectid, input_data=self.m_dep_work_dir, output_data=self.m_current_code_folder, nn_file=self.m_nn_file,
        ...
        return ret 
    def del_run(self):
        #print("test=", self.m_current_projectid)
