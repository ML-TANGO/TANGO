...
from Network.Tabular.FEATURE_ENGINEERING.FEATURE_SELECTION import model
...
if __name__ == '__main__':
    try:
        ...
        xTrain, xTest, yTrain, yTest, colNames, labelColName, labels, output = dataLib.getNdArray(param)

        if output["SUCCESS"]:
            try:
                output = model.getFeature(param, xTrain, yTrain, colNames, output)
