        ...
        if flag == 1:
            if xTest is None:
                ...
                if classes is None:
                    ...
                    # pred_prob = []
                    # for prob in yPredProb:
                    #     pred_prob.append(np.array(softmax(prob)))

                    # yPredProb = np.array(pred_prob)
            ...
            try:
                if xTest is None:
                    ...
                    try:
                        ...
                        score = model.decision_function(xTest)[0]
                        pred_prob = []
                        for prob in score:
                            pred_prob.append(softmax(score))
