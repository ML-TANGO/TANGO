...
from Network.Tabular.SCIKIT.SVC import predict, model
        ...
        if output["SUCCESS"]:
            ...
            gs = GridSearch(
                ...
                param_grid={
                    ...
                    "kernel": [str(param["kernel"])] if "kernel" in param else ["rbf"],
                    "degree": [int(param["degree"])] if "degree" in param else [3],
                    "gamma": [str(param["gamma"])] if "gamma" in param else ["scale"],
                    "probability":[True]
                },
                param=param,
                mode='clf'
