...
async def image_build(
    ...
    try:
        ...
        path = f"./tango/common/{user_id}/{project_id}/deployment.yml"  # TODO path could be changed when 공유폴더 is decided
        with open(path) as f:
        ...
        crud.create_task(user_input_data["user"])
...
async def get_container(
    ...
    try:
        ...
        status = crud.get_user_specific_tasks_status(user_data)
        return Response(
            content=status,
            status_code=200,
            media_type="text/plain"
