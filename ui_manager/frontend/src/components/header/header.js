...
//    const dispatch = useDispatch();
    ...
    {
        console.log('home_buttonClick')
    }

    /* 사이드 바 - 프로젝트 관리 버튼 클릭 이벤트 */
    const project_buttonClick = () =>
    {
        console.log('project_buttonClick')
    }

    /* 사이드 바 - 데이터 관리 버튼 클릭 이벤트 */
    const data_buttonClick = () =>
    {
        console.log('data_buttonClick')
    }

    /* 사이드 바 - 데이터 관리 버튼 클릭 이벤트 */
    const visual_buttonClick = () =>
    {
        console.log('visual_buttonClick')
    }
    ...
    return (
        ...
        <div style={{position:'relative', height:'100%', width:'100%'}}>
            ...
            <div className='header_menu' style={{height:'100%', width:'10%', float:'left'}}>
                ...
                <div className="header-menu-list" style={{top:'7vh', height:'auto', width:'100%'}}>
