    ...
    return (
        ...
        <div className="sidebar_menu" style={{width:'300px'}}>
            <div className="sidebar_list" style={{width:'100%'}}>
                ...
                {/* 사이드바 아이템 - 메인 */}
                <div className="sidebar_main" style={{padding:"50px 0px", justifyContent:'center'}}>
                    <Link to="/" onClick={ home_buttonClick }>
                        <img src={ Sidebar_main_image } alt="Deep Framework 로고 이미지 입니다." style={{ width:"75px", height:"75px"}}></img>
                        <br/>
                ...
                <div className="sidebar_item">
                    ...
                    {/* 로그인 페이지로 이동하며 로그아웃 이벤트 호출 */}
                    {/*
                    <Link to="/login">
                        <div className='item' id='item_3' onClick={logout} style={{backgroundColor:'#242933', bottom:'50px', position:'absolute'}}>
                            <div id='logout_button_icon'>
                    ...
                    */}
                    ...
                    {/*
                    <div className='item' id='item_3' onClick={() => logout()} style={{bottom:'50px', position:'absolute'}}>
                        <div id='logout_button_icon'>
                            <span className='item_text'>LOGOUT</span>
                        </div>
                    </div>
