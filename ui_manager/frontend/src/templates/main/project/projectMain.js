...
function ProjectMain()
{
    ...
    return (
        ...
        {/* 프로젝트 이름 수정 팝업 */}
        <Popup.ProjectRenamePopup getProject={getProject} newProjectName={newProjectName} setNewProjectName={setNewProjectName}  cancel_ButtonClick={() => modify_popup_Cancel_ButtonClick()} apply_ButtonClick={modify_popup_Apply_ButtonClick}/>
