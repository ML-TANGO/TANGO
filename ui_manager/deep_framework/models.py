"""model module for deep_frameowrk
...
class DeepProject(models.Model):
    """DeepProject class
    Note:
    Args:
        models.Model
    ...
    # 프로젝트 이름
    project_name = models.CharField(blank=True, null=True, max_length=30)                       

    # 프로젝트 설명
    project_description = models.CharField(blank=True, null=True, max_length=200)               

    # 생성자
    create_user = models.CharField(blank=True, null=True, max_length=50)                        

    # 생성 날짜
    create_date = models.CharField(blank=True, null=True, max_length=50)                        

    # 타겟 정보
    target = models.CharField(blank=True, null=True, max_length=100)                            

    # 타겟 yaml 파일 경로
    target_yaml_path = models.CharField(blank=True, null=True, max_length=1024, default='')     

    # 사용 데이터 셋 경로
    dataset_path = models.CharField(blank=True, null=True, max_length=200, default='')          

    # 데이터 셋 yaml 파일 경로
    data_yaml_path = models.CharField(blank=True, null=True, max_length=1024, default='')       

    # 신경망 생성 단계
    step = models.IntegerField(blank=True, null=True, default=0)                                

    # 신경망 생성 상태
    step_status = models.BooleanField(blank=True, null=True, default=False)                     

    # 타입 정보 ( detection, segmentation... )
    type = models.CharField(blank=True, null=True, max_length=50)                               

    class Meta:
        """DeepProject.Meta class
        Note:
        Args:
          None
        Attributes:
